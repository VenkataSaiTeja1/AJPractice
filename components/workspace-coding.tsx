      ...
      <div className={isMaximized 
        ...
        <div className={`flex flex-col gap-6 ${
          ...
          <div className="flex-1 glass-card border-slate-800 overflow-hidden flex flex-col min-h-0">
            ...
            <div className="flex-1 bg-slate-950/60 p-4 font-mono text-xs overflow-y-auto space-y-3 min-h-0">
              {limitReached && (
          ...
          <div className="h-[220px] glass-card border-slate-800 p-5 flex flex-col justify-between shrink-0">
